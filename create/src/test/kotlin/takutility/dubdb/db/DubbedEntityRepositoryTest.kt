...
internal abstract class DubbedEntityRepositoryTest<R: DubbedEntityRepository>: RepositoryTest<DubbedEntity, R>() {
    ...
    @Test
    fun findMostCommonDubber() {
        val dubbers = listOf<Dubber>(
            /* 0 */ Dubber("Luca Ward", ids = SourceIds.of(WIKI to "Luca_Ward")),
            /* 1 */ Dubber("Roberto Pedicini", ids = SourceIds.of(WIKI to "Roberto_Pedicini")),
            /* 2 */ Dubber("Laura Boccanera", ids = SourceIds.of(WIKI to "Laura_Boccanera", DUBDB to "d2a1e3df-9396-4df9-822f-5497a2ad3164")),
            /* 3 */ Dubber("Francesco Pannofino", ids = SourceIds.of(WIKI to "Francesco_Pannofino")),
            /* 4 */ Dubber("Emanuela Rossi", ids = SourceIds.of(WIKI to "Emanuela_Rossi")),
            /* 5 */ Dubber("Massimo Corvo", ids = SourceIds.of(WIKI to "Massimo_Corvo")),
            /* 6 */ Dubber("Ilaria Stagni", ids = SourceIds.of(WIKI to "Ilaria_Stagni", DUBDB to "ac9bd1db-cf3a-40f3-8adc-b5f1218a3b29")),
        )
